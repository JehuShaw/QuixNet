 ...
 */
#ifndef XQXTABLE1STORE_H
#define XQXTABLE1STORE_H
...
private:
	...
	private:
		friend class CXqxTable1Store<T>;
...
private:
	class CIteratorBase {
	public:
		CIteratorBase(const CXqxTable1Store<T>* pXqxTable, uint32_t nIndex)
	...
	public:
		...
		CIterator(const CXqxTable1Store<T>* pXqxTable, uint32_t nIndex)
	...
	public:
		...
		CReverseIterator(const CXqxTable1Store<T>* pXqxTable, uint32_t nIndex)
			: CIteratorBase(pXqxTable, nIndex) {
		}
...
public:
	...
	CXqxTable1Store(uint32_t nAllcSize = 0)
		: m_arrItems(NULL)
		, m_nAllcSize(0)
		, m_nCurSize(0)
	{

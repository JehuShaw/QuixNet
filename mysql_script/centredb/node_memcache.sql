...
INSERT INTO `containers` VALUES ('node_route_get', 'node_control_centre', 'SP_ROUTE_GET_RECORD', 'varchar(250)|bigint(20)', null, null, null, null, null);
...
INSERT INTO `containers` VALUES ('node_user_login', 'node_control_centre', 'SP_USER_LOGIN', 'bigint|%serverid%', 'int|smallint|varchar(21)|int', null, null, null, null);
INSERT INTO `containers` VALUES ('node_user_check', 'node_control_centre', 'user', 'account', 'index|server_id|creation_time|server_region', 'mc_flags', 'mc_cas', 'mc_expire', 'PRIMARY');
INSERT INTO `containers` VALUES ('node_bal_user_id', 'node_control_centre', 'user', 'index|server_id', null, null, null, null, 'PRIMARY');
...
INSERT INTO `db_server` VALUES ('1', '127.0.0.1', '3306', 'root', '08155', 'node_control_centre', '3');

...
#define CONFIG_PHYPOWER_BUY_VALUE std::string("Action_Buy_Value")
...
#define CONFIG_CHAPTER_DIFFICULT_TIMES std::string("Chapter_Hard_Times")
#define CONFIG_CHAPTER_DIFFICULT_DEBLOCKING std::string("Chapter_Hard_Deblocking")

#define CONFIG_COIN_BUY_VALUE std::string("Coin_Buy_Value")

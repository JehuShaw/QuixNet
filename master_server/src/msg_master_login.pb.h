...
#ifndef GOOGLE_PROTOBUF_INCLUDED_msg_5fmaster_5flogin_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_msg_5fmaster_5flogin_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_msg_5fmaster_5flogin_2eproto
...
struct TableStruct_msg_5fmaster_5flogin_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_msg_5fmaster_5flogin_2eproto;
namespace master {
class LoginRequest;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::master::LoginRequest* Arena::CreateMaybeMessage<::master::LoginRequest>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace master {
...
class LoginRequest :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:master.LoginRequest) */ {
 public:
  LoginRequest();
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_msg_5fmaster_5flogin_2eproto);
    return ::descriptor_table_msg_5fmaster_5flogin_2eproto.file_level_metadata[kIndexInFileMessages];
  }
 ...
 private:
  ...
  friend struct ::TableStruct_msg_5fmaster_5flogin_2eproto;
};
// ===================================================================
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 LoginRequest::account() const {
  // @@protoc_insertion_point(field_get:master.LoginRequest.account)
...
inline void LoginRequest::set_account(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  ...
  // @@protoc_insertion_point(field_set:master.LoginRequest.account)
}
...
inline const std::string& LoginRequest::sessionkey() const {
  // @@protoc_insertion_point(field_get:master.LoginRequest.sessionkey)
  return _internal_sessionkey();
}
inline void LoginRequest::set_sessionkey(const std::string& value) {
  _internal_set_sessionkey(value);
  // @@protoc_insertion_point(field_set:master.LoginRequest.sessionkey)
}
inline std::string* LoginRequest::mutable_sessionkey() {
  // @@protoc_insertion_point(field_mutable:master.LoginRequest.sessionkey)
...
inline void LoginRequest::set_sessionkey(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:master.LoginRequest.sessionkey)
}
inline void LoginRequest::set_sessionkey(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:master.LoginRequest.sessionkey)
}
inline void LoginRequest::set_sessionkey(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:master.LoginRequest.sessionkey)
}
...
inline std::string* LoginRequest::release_sessionkey() {
  // @@protoc_insertion_point(field_release:master.LoginRequest.sessionkey)
...
inline void LoginRequest::set_allocated_sessionkey(std::string* sessionkey) {
  ...
  // @@protoc_insertion_point(field_set_allocated:master.LoginRequest.sessionkey)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_msg_5fmaster_5flogin_2eproto
